...
use crate::graph_memory::{GraphRecallTool, GraphRememberTool};
...
use crate::python_execute::PythonExecuteTool;
...
tool_attribution!(GraphRecallTool, ToolKind::Memory);
tool_attribution!(GraphRememberTool, ToolKind::Memory);
...
tool_attribution!(JudgeTool, ToolKind::Plugin);
...
tool_attribution!(PythonExecuteTool, ToolKind::Shell);
